...
void PETEventAction::EndOfEventAction(const G4Event *event) {
  ...
  myfile501 << *(fProdCount+Thread_Id) << "," << *(fDetCountO+Thread_Id) << "," << *(fDetCountI+Thread_Id) << "," << *(fDetLoss+Thread_Id) << "," << *(fKillCount+Thread_Id) << "," << *(fPhotTimeO+Thread_Id) << "," << *(fPhotTimeI+Thread_Id) <<std::endl;
  myfile501.close();
  *(fProdCount+Thread_Id) = 0;
  *(fDetCountO+Thread_Id) = 0;
  *(fDetCountI+Thread_Id) = 0;
  *(fDetLoss+Thread_Id) = 0;
  *(fKillCount+Thread_Id) = 0;
  *(fPhotTimeO+Thread_Id) = 0;
  *(fPhotTimeI+Thread_Id) = 0;
