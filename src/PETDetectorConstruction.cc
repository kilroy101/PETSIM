...
//3x3 blocks of pixelated crystals
...
void PETDetectorConstruction::BuildMaterial() {
    ...
    G4double LYSOatt[num] = {1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm,1.2*cm};

    G4double BGOatt[num] =
    {1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm, 1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm, 1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm,1.0*cm};
    ...
    fBGO_MPT->AddProperty("FASTCOMPONENT", Penergy, fast, num)->SetSpline(true);
    fBGO_MPT->AddConstProperty("RINDEX", 2.15);
    fBGO_MPT->AddProperty("ABSLENGTH", Penergy, BGOatt, num);
    ...
    fLYSO_MPT->AddProperty("FASTCOMPONENT", Penergy, fast, num)->SetSpline(true);
    fLYSO_MPT->AddProperty("RINDEX", Penergy, rLyso, num);
    fLYSO_MPT->AddProperty("ABSLENGTH", Penergy, LYSOatt, num);
    fLYSO_MPT->AddConstProperty("SCINTILLATIONYIELD", 32000 / MeV);
    fLYSO_MPT->AddConstProperty("RESOLUTIONSCALE", 1);
    fLYSO_MPT->AddConstProperty("FASTTIMECONSTANT", 43 * ns);

    fAir_MPT->AddProperty("RINDEX", Penergy, rAir, num);

    fGel_MPT->AddProperty("RINDEX", Penergy, rGel, num);
...
G4VPhysicalVolume * PETDetectorConstruction::Construct() {
  ...
  G4double cryst_dx = 3.0*mm, cryst_dy = 3.0*mm, cryst_dz = 3.0*mm;
  G4double det_dx = 3*mm, det_dy = 3*mm, det_dz = 1*mm;
  G4double gap_c = 0.2*mm;

  G4int nb_block =40;
  G4int nb_crys = 8;
  //G4double block_dx = nb_crys*cryst_dx+(nb_crys+1)*gap_c, block_dy = nb_crys*cryst_dx+(nb_crys+1)*gap_c, block_dz = cryst_dz+2*det_dz;
  //G4int nb_rings = 8;
  G4double block_dx = 25.8*mm, block_dy = 25.8*mm, block_dz = 25*mm;
  ...
  G4double ring_R2 = (ring_R1+cryst_dz)/cosdPhi;//unknown
  //
  ...
  G4Tubs* solidIRing =
    new G4Tubs("RingI", ring_R1-15*mm, ring_R2+2*det_dz+15*mm, 0.5*block_dy, -0.5*dPhi, dPhi);
    G4LogicalVolume* logicIRing =
      new G4LogicalVolume(solidIRing, fAir,"RingI");

  G4Box* solidCryst = new G4Box("crystal", block_dx/2, block_dy/2, block_dz/2);
  ...
  G4LogicalVolume* logicDet_outer =
    new G4LogicalVolume(solidDet_outer,fAir,"detector");
  ...
  for (G4int imod = 0; imod < 1; imod++){ //0-3
  ...
  //  for (G4int jcrys = 0; jcrys < 8 ; jcrys++){
  //    G4int CrysCopyNumber = jcrys + 8*icrys;

      // Pixelated crystal geometry G4ThreeVector position_cryst = G4ThreeVector(Bx - (3.5-icrys)*1.13*det_dx*sin(phi) +0.5*det_dz,//ODx - (3.5-icrys)*det_dx*sin(phi),
      //                                               By+(3.5-icrys)*1.07*det_dx*cos(phi),
      //                                               (3.5-jcrys)*1.07*det_dx); //with rotation, 1.07 to account for 0.2 space between detectors
      G4ThreeVector position_cryst = G4ThreeVector(ring_R1+0.5*cryst_dz, 0,0);
      G4Transform3D transform_cryst = G4Transform3D(rotm,position_cryst);
        new G4PVPlacement(transform_cryst,             //rotation,position
                          ...
                          icrys,                 //copy number, put CrysCopyNumber here for pixelated
  ...
  G4ThreeVector Side_gel_position = G4ThreeVector(ring_R1+0.5*cryst_dz,
                                                     ODy+(3.5-icrys)*1.07*det_dx*cos(phi),
                                                     (4-jgel)*1.07*det_dx);

  G4ThreeVector Top_gel_position = G4ThreeVector(ring_R1+0.5*cryst_dz,
...
new G4PVPlacement(Top_gel_transform,
    ...
    }}//end of gels, for pixelated detectors*/
    for (G4int idet = 0; idet < 8 ; idet++){
    for (G4int jdet = 0; jdet < 8 ; jdet++){
    G4int OutdetCopyNumber = jdet + 8*idet + 64;
    G4ThreeVector position_out_det = G4ThreeVector(ODx+det_dz- (3.5-idet)*1.13*det_dx*sin(phi),//ODx - (3.5-icrys)*det_dx*sin(phi),
    ODy+(3.5-idet)*1.07*det_dx*cos(phi),
    (3.5-jdet)*1.07*det_dx); //with rotation, 1.07 to account for 0.2 space between detectors
    G4Transform3D transform_out_det = G4Transform3D(rotm_out,position_out_det);
	 ...
	 new G4PVPlacement(transform_out_det,             //rotation,position
             ...
             G4int IndetCopyNumber = jdet + 8*idet;
             G4ThreeVector position_in_det = G4ThreeVector(IDx- (3.5-idet)*det_dx*sin(phi)+0.4*cos(phi)*mm,//ODx - (3.5-icrys)*det_dx*sin(phi),
             IDy+(3.5-idet)*1.07*det_dx*cos(phi)+0.4*sin(phi)*mm,
             (3.5-jdet)*1.07*det_dx);
...
//end of pixelated crystls  }} // end of cryst
}// end of imod
for (G4int imod_radial = 0; imod_radial < 20 ; imod_radial++){
  for (G4int imod_vertical = 0; imod_vertical < 3 ; imod_vertical++){
    G4RotationMatrix rotm  = G4RotationMatrix();
    G4double phi = (imod_radial-1)*dPhi;
    rotm.rotateZ(phi);
    G4ThreeVector position_mod = G4ThreeVector(0,0,(25.78*imod_vertical));//(ring_R1+0.5*cryst_dz)*std::cos(phi), (ring_R1+0.5*cryst_dz)*std::sin(phi), (25.78*imod_vertical));
  ...
  new G4PVPlacement(transform_mod,                     //no rotation
        ...
        logicIRing->SetVisAttributes (SiPMVisAttributes);//);//G4VisAttributes::Invisible
